const styles = {
    ...
    button: 'w-[150px] bg-[#f68712] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    button_outline: 'w-[150px] bg-[#f68712] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer outline outline-offset-2 outline-1',
    underline_text: 'w-[150px] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
